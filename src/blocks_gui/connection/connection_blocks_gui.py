...
class GUIConnectionCorner(GUIBlock):
    ...
    def left_dragged(self, event):
        ...
        move_x, move_y = super().left_dragged(event, max_positive_move_x=max_positive_move_x, max_negative_move_x=max_negative_move_x, max_positive_move_y=max_positive_move_y, max_negative_move_y=max_negative_move_y, single_direction=True)
