...
from yacraf_calculator.helper_functions_general import convert_grid_coordinate_to_actual, convert_actual_coordinate_to_grid, get_actual_coordinates_after_scale, distance_to_closest_grid_intersection, get_font, get_text_that_fits, delete_all
...
class GUIBlock:
    ...
    def __init__(self, model, view, pressable_items, x, y, width, height, *, ignore_zoom=False, bind_left=None, bind_right=None):
        ...
        from yacraf_calculator.blocks_gui.connection.connection_blocks_gui import GUIConnectionCorner
