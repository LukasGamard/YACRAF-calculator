from yacraf_calculator.blocks_calculation.configuration.configuration_attribute_calculation import ConfigurationAttribute
from yacraf_calculator.blocks_calculation.setup.setup_class_calculation import SetupClass
